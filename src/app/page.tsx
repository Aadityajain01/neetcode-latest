...
function LandingPage() {
  ...
  return (
    <div className="h-[100dvh] min-h-[100dvh] bg-zinc-950 text-zinc-200 selection:bg-zinc-800 font-sans overflow-y-scroll scrollbar-emerald">
        ...
        <div className="container mx-auto px-6 max-w-7xl flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/register">
                <Button className="bg-white hover:bg-zinc-200 text-zinc-950 font-bold tracking-widest uppercase text-[11px] rounded-xl px-6 transition-all hover:scale-105">
                  Get Started
                </Button>
              </Link>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden absolute top-full left-0 w-full bg-zinc-950/95 backdrop-blur-xl border-b border-zinc-800 p-6 flex flex-col gap-4 shadow-2xl animate-in slide-in-from-top-2">
            ...
            <Link href="/register" onClick={() => setMobileMenuOpen(false)}>
              <Button className="w-full bg-white text-zinc-950 hover:bg-zinc-200 text-xs font-bold uppercase tracking-widest">Get Started</Button>
            </Link>
          </div>
        )}
      </nav>
      ...
      <section className="relative pt-40 pb-20 lg:pt-56 lg:pb-32 ">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-5xl">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-900/50 border border-zinc-800/50 text-zinc-300 text-[10px] uppercase tracking-widest font-bold mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300">
            <Link href="/register">
              <Button size="lg" className="h-14 px-8 text-sm uppercase tracking-widest bg-white hover:bg-zinc-200 text-zinc-950 font-bold shadow-[0_0_30px_-5px_rgba(255,255,255,0.15)] rounded-xl transition-all hover:-translate-y-1">
      ...
      <section id="features" className="py-24 relative z-10">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="text-center mb-16">
             <h2 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-3">Core Engine</h2>
               ...
               <div className="grid md:grid-cols-2 gap-12 items-center">
                 ...
                 <div className="flex items-end justify-center gap-2 sm:gap-4 h-48 mt-8 md:mt-0">
                    <div className="w-20 sm:w-24 bg-zinc-800/50 border border-zinc-700/50 p-2 rounded-t-xl flex flex-col items-center justify-end h-[60%] relative group">
                     ...
                     <div className="w-24 sm:w-28 bg-gradient-to-t from-zinc-600/40 to-zinc-500/10 border border-zinc-500/30 p-2 rounded-t-xl flex flex-col items-center justify-end h-[90%] relative shadow-[0_-10px_30px_rgba(255,255,255,0.05)]">
                        <div className="w-10 h-10 rounded-full bg-zinc-100 absolute -top-5 border-2 border-zinc-900 shadow-lg text-zinc-950 font-bold flex items-center justify-center text-xs">A</div>
                        <Trophy className="w-4 h-4 text-zinc-100 absolute top-6" />
                        <div className="text-4xl font-black text-white opacity-80 mt-auto">1</div>
                     </div>
